...
class StepFourOrder extends StatefulWidget {
  ...
  @override
  _StepFourOrderState createState() => _StepFourOrderState(typeSelected: this.typeSelected);
}

class _StepFourOrderState extends State<StepFourOrder> {
  static var routeName = "/stepfour";
  String typeSelected;
  ...
  void afterDelay() {
    Future.delayed(Duration(seconds: 5), () {
      Navigator.of(context).pushNamed('/stepfive', arguments: typeSelected);
    });
  }
