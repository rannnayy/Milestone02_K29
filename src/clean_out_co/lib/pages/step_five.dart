...
class StepFiveOrder extends StatefulWidget {
  ...
  @override
  _StepFiveOrderState createState() => _StepFiveOrderState(typeSelected: this.typeSelected);
}

class _StepFiveOrderState extends State<StepFiveOrder> {
  static var routeName = "/stepfive";
  String typeSelected;
  ...
  void afterDelay() {
    Future.delayed(Duration(seconds: 5), () {
      Navigator.of(context).pushNamed('/stepsix', arguments: typeSelected);
    });
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextDisplays(
                      ...
                      textData: "Warrior mengantar sampah\nmenuju TPS.",
