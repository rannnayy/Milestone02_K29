...
class StepThreeOrder extends StatefulWidget {
  ...
  @override
  _StepThreeOrderState createState() => _StepThreeOrderState(typeSelected: this.typeSelected);
}

class _StepThreeOrderState extends State<StepThreeOrder> {
  static var routeName = "/stepthree";
  String typeSelected;

  _StepThreeOrderState({
    required this.typeSelected,
  });

  void afterDelay() {
    Future.delayed(Duration(seconds: 5), () {
      Navigator.of(context).pushNamed('/stepfour', arguments: typeSelected);
    });
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextDisplays(
                      ...
                      textData: "Sudah dapat Warrior, nih!\nSedang menuju ke tempat kamu!",
